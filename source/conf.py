...
project = u'OpenStreetMap, Imposm y TileMill'
...
htmlhelp_basename = 'JosmImposmTilemillWorkshop'
...
latex_documents = [
  ('index', 'JosmImposmTilemillWorkshop.tex', u'OSM + IMPOSM + TILEMILL',
...
epub_title = u'Taller Josm Imposm Tilemill'
epub_author = u'Geoinquietos Valencia'
epub_publisher = u'Geoinquietos Valencia'
epub_copyright = u'2014, Geoinquietos Valencia'
