# -*- coding: utf-8 -*-
#
# OSM + IMPOSM + TILEMILL Documentation documentation build configuration file, created by
# sphinx-quickstart on Tue Dec 20 18:13:31 2011.
#
...
project = u'OSM + IMPOSM + TILEMILL'
copyright = u'2012 Taller Josm + ImpOSM + Tilemill por Pedro-Juan Ferrer Matoses se encuentra bajo una Licencia Creative Commons Atribución-CompartirIgual 3.0 Unported.'
...
htmlhelp_basename = 'OIT'

html_style='omnium.css'
...
latex_documents = [
  ('index', 'OIT.tex', u'OSM + IMPOSM + TILEMILL',
   u'Pedro-Juan Ferrer Matoses', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'img/logo_omnium.jpg'
...
latex_elements = {
    ...
    \fancyhead[CE,CO]{{Omnium Inteligencia Estratégica}}%
    \fancyhead[LE,RO]{{\pyHeaderFamily \title,%
     \releasename\space\version}}%
        \renewcommand{\headrulewidth}{0.4pt}%
        \renewcommand{\footrulewidth}{0.4pt}%
        % changes
        \fancyhead[LO,RE]{{\includegraphics[height=0.8cm]{logo_omnium.jpg}}}%
}
'''
}
...
man_pages = [
    ('index', 'oit', u'OSM + IMPOSM + TILEMILL',
     [u'Pedro-Juan Ferrer Matoses'], 1)
]
...
texinfo_documents = [
  ('index', 'OIT', u'OSM + IMPOSM + TILEMILL',
   u'Pedro-Juan Ferrer Matoses', 'OIT', 'OSM + IMPOSM + TILEMILL.',
   'Miscellaneous'),
]
